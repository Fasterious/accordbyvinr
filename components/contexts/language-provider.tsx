...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const translations: Record<Language, Record<string, string>> = {
    fr: {
      ...
      "be_among_first": "Soyez Parmi les Premiers",
      "join_early_access": "Rejoignez notre programme d'accès anticipé et transformez votre marque de boisson en une expérience interactive",
      "language": "Langue",
    ...
    en: {
      ...
      "be_among_first": "Be Among the First",
      "join_early_access": "Join our early access program and transform your beverage brand into an interactive experience",
      "language": "Language",
